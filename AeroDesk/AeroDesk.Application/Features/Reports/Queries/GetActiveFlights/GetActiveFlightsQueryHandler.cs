...
{
    public class GetActiveFlightsQueryHandler
        : IRequestHandler<GetActiveFlightsQuery, List<FlightReportDto>>
    {
        ...
        public GetActiveFlightsQueryHandler(IApplicationDbContext context)
        {
            _context = context;
        }

        public async Task<List<FlightReportDto>> Handle(
            GetActiveFlightsQuery request,
